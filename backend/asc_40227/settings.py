"""
Django settings for asc_40227 project.
...
WSGI_APPLICATION = 'asc_40227.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asc_40227 API",
    "DESCRIPTION": "API documentation for asc_40227 App",
    "VERSION": "v1",
}
